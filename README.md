...
The offline tax data is pulled from [VAT, GST and sales tax rates — ey.com](https://www.ey.com/gl/en/services/tax/worldwide-vat--gst-and-sales-tax-guide-2019---rates) (2019 rates) and [Value-added tax (VAT) rates — PwC](http://taxsummaries.pwc.com/ID/Value-added-tax-(VAT)-rates) (last updated: 24th May 2019).
